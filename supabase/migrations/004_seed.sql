...
insert into public.members (id, display_id, name, phone, parent_phone, birth_date, gender, source, status, sessions_remaining, total_sessions, expires_at, member_since, package_name, assigned_coach_id, freeze_days_used, freeze_days_total) values
  ('00000000-0000-0000-0000-000000000a01', 'M001', 'Ahmed Al-Rashid', '055-0101', '055-0100', '1998-03-15', 'male',   'Walk-in',   'active',        8, 12, now() + interval '14 days', now() - interval '60 days', '12 Sessions',       '00000000-0000-0000-0000-000000000c01', 0, 7),
  ('00000000-0000-0000-0000-000000000a02', 'M002', 'Nour Hassan',     '055-0102', '055-0109', '2002-07-22', 'female', 'Instagram', 'expiring_soon', 2, 8,  now() + interval '2 days',  now() - interval '30 days', '8 Sessions',        '00000000-0000-0000-0000-000000000c02', 3, 7),
  ('00000000-0000-0000-0000-000000000a03', 'M003', 'Kareem Mansour',  '055-0103', null,       '1995-11-08', 'male',   'Referral',  'expired',       0, 12, now() - interval '5 days',  now() - interval '90 days', '12 Sessions',       '00000000-0000-0000-0000-000000000c03', 0, 7),
  ('00000000-0000-0000-0000-000000000a04', 'M004', 'Sara Al-Fahed',   '055-0104', '055-0111', '2001-01-30', 'female', 'Facebook',  'has_debt',      10, 12, now() + interval '25 days', now() - interval '5 days',  '12 Sessions',       '00000000-0000-0000-0000-000000000c02', 0, 7),
  ('00000000-0000-0000-0000-000000000a05', 'M005', 'Layla Ibrahim',   '055-0105', null,       '1999-05-14', 'female', 'WhatsApp',  'active',        6, 8,  now() + interval '18 days', now() - interval '15 days', '8 Sessions',        '00000000-0000-0000-0000-000000000c02', 0, 7),
  ('00000000-0000-0000-0000-000000000a06', 'M006', 'Omar Khalil',     '055-0106', null,       '1993-09-03', 'male',   'Walk-in',   'active',        999, 999, now() + interval '20 days', now() - interval '10 days', 'Unlimited Monthly', '00000000-0000-0000-0000-000000000c01', 2, 14),
  ('00000000-0000-0000-0000-000000000a07', 'M007', 'Rania Saleh',     '055-0107', '055-0120', '2003-12-19', 'female', 'Instagram', 'expiring_soon', 1, 12, now() + interval '1 day',   now() - interval '45 days', '12 Sessions',       '00000000-0000-0000-0000-000000000c01', 0, 7),
  ('00000000-0000-0000-0000-000000000a08', 'M008', 'Hassan Yousef',   '055-0108', null,       '1990-06-25', 'male',   'Referral',  'expired',       2, 12, now() - interval '3 days',  now() - interval '75 days', '12 Sessions',       '00000000-0000-0000-0000-000000000c03', 7, 7);
